					...
					<div className='md:flex hidden flex-col font-bold'>
						...
						<div className=' flex flex-col pt-20 gap-10  '>
							...
							<p className='text-xl font-thin text-center'>
								...
								взял у отца <br /> пару сотен долларов <br /> взаймы, рискнул —
								и
								<br />
						...
						<div className=' flex flex-col gap-10 pt-28 '>
							...
							<p className='text-xl font-thin text-center'>
								...
								атлетике, и первокурсник <br /> Фил Найт — бегун <br /> на
								среднюю дистанцию. <br /> Двое мужчин, страстно любящих <br />{' '}
								спорт, сразу же нашли <br /> общий язык. Билл Бауэрман <br />{' '}
								воспитал множество <br /> олимпийских чемпионов <br /> из числа
								студентов университета, <br />
								уделяя большое внимание <br /> их всестороннему развитию, а{' '}
								<br />
								не только физическим <br /> тренировкам. В 1972 году <br /> его
								пригласили занять пост
								<br /> тренера олимпийской команды
								<br /> США по легкой атлетике. <br /> После смерти великого
								коуча
								<br />
